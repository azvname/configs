...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "go-api" '("defgeneric-w-setf" "go-" "ignoring-unsupported")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "go-board" '("*autoplay*" "*b" "*go-board-overlays*" "*history*" "*size*" "*t" "*white*" "alive-p" "apply-" "black-piece" "board" "clear-labels" "go-" "make-board" "move-type" "neighbors" "other-color" "pieces-to-board" "player-to-string" "point-of-pos" "remove-dead" "update-display" "white-piece" "with-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "go-util" '("*go-partial-line*" "aget" "alistp" "char-to-num" "compose" "curry" "ear-muffs" "go-" "indexed" "make-go-insertion-filter" "num-to-char" "pos-to-index" "range" "rpush" "set-aget" "sym-cat" "take" "transpose-array" "un-ear-muffs" "until")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "list-buffer" '("*buffer-" "*enter-function*" "*refresh-function*" "list")))
